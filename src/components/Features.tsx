...
const items = [
  {
    ...
    title: 'View and visualize your factory layout',
    description:
  ...
  {
    icon: <ViewInArIcon />,
    title: 'Pre-built 3D Models',
    description:
      'Access a library of 30+ 3D models, including CNC\'s, Robots, and more. All assets can be customized to match your factory floor.',
